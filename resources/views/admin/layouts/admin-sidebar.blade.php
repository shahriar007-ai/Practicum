<ul class="navbar-nav sidebar sidebar-bg-admin sidebar-dark accordion" id="accordionSidebar">
	...
	<li class="nav-item">
		...
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item" href="{{route('subcategory.list')}}">SubCategory</a>
	...
	<li class="nav-item">
		<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#shipping"
			aria-expanded="true" aria-controls="collapseUtilities">
			<i class="fas fa-truck-pickup"></i>
			<span>Shipping</span>
		</a>
		<div id="shipping" class="collapse" aria-labelledby="headingUtilities"
			data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<!-- <h6 class="collapse-header">Custom Utilities:</h6> -->
