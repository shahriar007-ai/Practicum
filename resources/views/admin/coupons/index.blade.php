		...
		<div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold custom-header-color">All Coupons</h6>
                    <a class="btn btn-sm btn-success text-white font-weight-bold  m-0" href="{{route('coupon.add')}}">Add Coupon</a>
				</div>
                <div class="card-body">
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="border-top-0">Coupon Code</th>
                                <th scope="col" class="border-top-0">Coupon Amount</th>
                        ...
                        <tbody>
                            ...
                            @forelse($coupons as $coupon)
                                <tr>
                                    ...
                                    <td><a href="{{route('coupon.edit',$coupon->id)}}"><i style="color:green;font-size:14px;" class="fas fa-edit"></i></a>&nbsp;&nbsp;
                                    <a href="{{route('coupon.delete',$coupon->id)}}" onclick="return confirm('Do you really want to delete this coupon?');"><i style="color:red;font-size:14px;" class="fas fa-trash-alt"></i></a></td>
                                </tr> 
                            @empty
                                <tr>
